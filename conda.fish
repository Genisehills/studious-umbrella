set -gx CONDA_EXE (cygpath "E:/SOFTWARE/ANACONDA\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "E:/SOFTWARE/ANACONDA")
set _CONDA_EXE (cygpath "E:/SOFTWARE/ANACONDA\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "E:/SOFTWARE/ANACONDA\python.exe")
